    ...
    return (
        <div className="relative w-full h-screen overflow-hidden bg-[#0B0C0E]">
            ...
            {viewPhase === 2 && showMobileDetail && (
                <button onClick={() => setShowMobileDetail(false)} className="fixed top-6 right-6 z-[100] md:hidden px-4 py-2 bg-black/80 border border-orange-500 rounded-sm text-orange-500 font-terminal text-2xl">↶</button>
            )}
